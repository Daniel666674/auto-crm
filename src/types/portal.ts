...
export const PORTAL_WIDGETS: PortalWidget[] = [
  ...
  // Marketing
  { id: "mkt-engagement", category: "marketing", label: "Engagement de marketing", description: "Emails enviados, open/click rate, leads calientes", requires: ["brevo-connection"] },
  { id: "mkt-campaigns", category: "marketing", label: "Campañas activas", description: "Métricas por campaña (open, click, conversiones)", requires: ["brevo-connection"] },
  { id: "mkt-attribution", category: "marketing", label: "Atribución de revenue", description: "Qué canales/campañas generaron deals ganados", requires: ["brevo-connection"] },
];
...
export const REQUIREMENTS_MAP: Record<string, { label: string; detail: string }> = {
  ...
  "brevo-connection": { label: "Brevo conectado en Integraciones", detail: "Sin Brevo, las métricas de marketing no se cargarán" },
